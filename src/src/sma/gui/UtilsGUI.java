...
public class UtilsGUI {
  ...
  public static Color fonsAreaTreball = new Color(250,250,250); //griset mes clar
  ...
  public static Color fonsBoto = new Color(240,210,160); //marro mes fosquet
  public static Font fontBoto = new Font("Arial",0,11);
  public static Color colorTextBoto = Color.BLACK;


  static public Color colorBackgroundFrame = new Color(240,210,160); //marro mes fosquet
