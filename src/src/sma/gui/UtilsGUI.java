...
public class UtilsGUI {
  ...
  public static Color fonsAreaTreball = new Color(250,250,250); //griset m�s clar
  ...
  public static Color fonsBoto = new Color(240,210,160); //marr� m�s fosquet
  public static Font fontBoto = new Font("Arial",0,11);
  public static Color colorTextBoto = Color.BLACK;


  static public Color colorBackgroundFrame = new Color(240,210,160); //marr� m�s fosquet
